function Hero() {
  return (
    <section id="hero" className="bg-gradient-to-t from-gray-900 via-purple-950 to-black text-white overflow-hidden h-screen flex flex-col justify-center items-center text-center px-6">
      <div className="relative z-10 text-center max-w-3xl">
        <h2 className="text-4xl md:text-6xl font-extrabold">
          Hi, I’m <span className="text-indigo-400">Abinaya</span>
        </h2>
