...
import { faArrowRight, faEnvelope, faCode } from "@fortawesome/free-solid-svg-icons";
...
function Home() {
  const skills = [
            { icon: git, name: "Git", cert: "https://www.dicoding.com/certificates/MRZMNMDRRPYQ" },
            { icon: github, name: "GitHub", cert: "https://www.dicoding.com/certificates/MRZMNMDRRPYQ" },
            { icon: html, name: "HTML", cert: "https://www.dicoding.com/certificates/JLX19RGN5P72" },
            { icon: css, name: "CSS", cert: "https://www.dicoding.com/certificates/4EXGVRNEDXRL" },
            { icon: tailwind, name: "Tailwind", cert: "https://www.dicoding.com/certificates/4EXGVRNEDXRL" },
            { icon: js, name: "JavaScript", cert: "https://www.dicoding.com/certificates/KEXL7DL9MXG2" },
            { icon: react, name: "React", cert: "https://www.dicoding.com/certificates/KEXL7DL9MXG2" }
          ]
  ...
  return (
    <main className="bg-gray-900 text-white min-h-screen font-sans">
      ...
      >
        ...
        <div className="relative z-10 text-center max-w-4xl">
          <div className="inline-flex items-center gap-2 bg-purple-900/30 border border-purple-500/30 rounded-full px-4 py-2 mb-6">
            <FontAwesomeIcon icon={faCode} className="text-purple-400 text-sm" />
          ...
          <p className="mt-6 text-xl text-gray-300 max-w-2xl mx-auto leading-relaxed">
            Passionate about building clean, responsive web applications with modern technologies 
      ...
      <section id="about" className="max-w-6xl mx-auto px-6 py-24">
        ...
        <div className="flex flex-col lg:flex-row gap-12 items-center">
          ...
          <div className="lg:w-3/5 space-y-6">
            <h3 className="text-2xl font-bold text-purple-300">Kheira Abinaya Gavin Lovedila</h3>
            <p className="text-lg text-gray-300 leading-relaxed">
              A dedicated student at SMK Negeri 7 Semarang, specializing in Network and Application 
              Information System. My passion lies in technology, software development, and artificial 
              intelligence, with a focus on creating innovative solutions for real-world challenges.
            </p>
            <p className="text-lg text-gray-300 leading-relaxed">
              Through active participation in school organizations, I've honed my leadership, teamwork, 
              and project management skills. Currently, I'm deepening my expertise in modern web 
              technologies including JavaScript, HTML, and Tailwind CSS, while continuously exploring 
              emerging technologies in the field.
            </p>
            <p className="text-lg text-gray-300 leading-relaxed">
              I'm excited to collaborate on innovative projects, contribute to meaningful solutions, 
              and grow professionally in dynamic tech environments.
            </p>
          </div>
        </div>
      </section>
      ...
      {/* Skills Section */}
      <section id="skills" className="max-w-6xl mx-auto px-6 py-24 bg-gray-800/50 rounded-3xl mx-6">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold mb-4 bg-gradient-to-r from-white to-purple-200 bg-clip-text text-transparent">
            Skills
          </h2>
        ...
        <div className="flex flex-col lg:flex-row gap-12 items-center">
          <div className="lg:w-2/5 hidden lg:block">
            <div className="relative">
              <div className="absolute -inset-4 bg-gradient-to-r from-purple-600 to-indigo-600 rounded-2xl blur opacity-25"></div>
              <img src={contact} alt="Contact" className="relative rounded-2xl shadow-2xl" />
            </div>
          </div>
          ...
          <div className="lg:w-3/5 w-full">
            ...
            <div className="mt-12">
              ...
              <div className="flex justify-center gap-6 flex-wrap">
                {[
                  { icon: faInstagram, href: "https://www.instagram.com/abinaya_4o4?igsh=MWMwZzRqaTNtbjkxbw==", label: "Instagram" },
                  { icon: faLinkedin, href: "https://www.linkedin.com/in/kheira-abinaya-677ba2286", label: "LinkedIn" },
                  { icon: faGithub, href: "https://github.com/481n4y4", label: "GitHub" },
                  { icon: faFacebook, href: "https://www.facebook.com/kheira.abinaya?mibextid=ZbWKwL", label: "Facebook" },
                  { icon: faWhatsapp, href: "https://wa.me/6285179902663", label: "WhatsApp" }
                ].map((social, index) => (
                  <a
                    key={index}
                    href={social.href}
